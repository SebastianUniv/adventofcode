...
describe('day 4', () => {
    describe('data', () => {
        ...
        const cases = [[(0, index_1.loadData)('test/boards')], [(0, index_1.loadData)('boards')]];
    ...
    describe('solution', () => {
        test('part 1 should return correct test score', () => {
            const boards = (0, index_1.loadData)('test/boards');
        ...
        test('part 2 should return correct test score', () => {
            ...
            const solver = new index_1.PartTwoSolver(boards, pulledTestNumbers);
            expect(solver.solve()).toEqual(expectedScore);
        });
    });
});
